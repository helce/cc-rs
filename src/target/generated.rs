...
pub(crate) const LIST: &[(&str, TargetInfo)] = &[
    ...
    (
        ...
        TargetInfo {
            full_arch: Cow::Borrowed("e2k"),
            arch: Cow::Borrowed("e2k"),
            vendor: Cow::Borrowed("unknown"),
            os: Cow::Borrowed("linux"),
            env: Cow::Borrowed("gnu"),
            abi: Cow::Borrowed(""),
            unversioned_llvm_target: Cow::Borrowed("e2k-unknown-linux-gnu"),
        },
    ),
    (
        "e2k12c-unknown-linux-gnu",
        TargetInfo {
            full_arch: Cow::Borrowed("e2k12c"),
            arch: Cow::Borrowed("e2k"),
            vendor: Cow::Borrowed("unknown"),
            os: Cow::Borrowed("linux"),
            env: Cow::Borrowed("gnu"),
    ...
    (
        ...
        TargetInfo {
            full_arch: Cow::Borrowed("e2k1cplus"),
            arch: Cow::Borrowed("e2k"),
            vendor: Cow::Borrowed("unknown"),
            os: Cow::Borrowed("linux"),
            env: Cow::Borrowed("gnu"),
