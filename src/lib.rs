...
impl Build {
    ...
    fn add_default_flags(
        ...
        if self.get_debug() {
            ...
            family.add_debug_flags(
                ...
                self.get_dwarf_version(cmd.family),
            );
        }
    ...
    fn get_base_compiler(&self) -> Result<Tool, Error> {
        ...
        if target.env == "msvc" && tool.family.is_gnu() {
            self.cargo_output
